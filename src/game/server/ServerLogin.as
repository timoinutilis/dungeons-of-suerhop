package game.server
{
	...
	public class ServerLogin
	{
		...
		public function ServerLogin(variables:URLVariables, onCompleteFunc:Function)
		{
			m_onCompleteFunc = onCompleteFunc;
			
			m_request = new URLRequest(GameDefs.k_ONLINE_SERVER_LOGIN_URL);
			...
			MagicStone.log("LOGIN: " + variables.toString());
		}
		...
		private function onComplete(event:Event):void
		{
			...
			var answer:AnswerUserId = new AnswerUserId();
			answer.isOk = data.isOk as Boolean;
			answer.error = data.error as String;
			answer.userId = data.result as int;
